...
- [x] Create Beads issue and approved OpenSpec change.
- [x] Add failing tests for July 2026 aliases, benchmark variants, Fireworks Kimi K2.7 mapping, and gated roster decisions.
...
- [x] Deploy Cloud Run and smoke production.
- [ ] Open Forgejo PR, pass CI, merge, mirror to GitHub.
- [ ] Archive OpenSpec, close Beads issue, clean worktree, and store memory.
