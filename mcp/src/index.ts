    ...
    tools: [
      {
        ...
        description:
          ...
          "3-stage deliberation: 9 individual responses -> 3 evaluators rank with self-exclusion -> chairman synthesizes from curated top-5 (Fable 5). " +
        ...
        inputSchema: {
          ...
          properties: {
            ...
            compact: {
              type: "boolean",
              description:
                "Use only 5 core models (GPT-5.5, Fable 5, Fireworks GLM-5.2 xHigh, Gemini 3.1 Pro, Grok 4.3) for faster/cheaper deliberation",
              default: false,
            },
            include_details: {
              type: "boolean",
